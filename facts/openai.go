...
Ищите только связи типов:  BEGIN (Основан), INVESTED_IN (Инвестировал в), FOUNDED/COFOUNDED (Основал, Соосновал),
EMPLOYED_AT (Работает в, Назначен руководителем, Вошел в состав совета, комитета и так далее),
